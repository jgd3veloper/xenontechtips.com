...
$img_before_alt = Elementor\Control_Media::get_image_alt( $this->__processed_item['item_before_image'] );
$img_after_alt  = Elementor\Control_Media::get_image_alt( $this->__processed_item['item_after_image'] );
