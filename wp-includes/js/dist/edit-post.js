...
/* harmony default export */ var prevent_event_discovery = ({
  't a l e s o f g u t e n b e r g': function tALESOFGUTENBERG(event) {
    ...
    window.wp.data.dispatch('core/block-editor').insertBlock(window.wp.blocks.createBlock('core/paragraph', {
      content: 'ðŸ¡ðŸ¢ðŸ¦€ðŸ¤ðŸ¦‹ðŸ˜ðŸ§ðŸ¹ðŸ¦ðŸ¦„ðŸ¦ðŸ¼ðŸ¿ðŸŽƒðŸ´ðŸðŸ†ðŸ¦•ðŸ¦”ðŸŒ±ðŸ‡Ï€ðŸŒðŸ‰ðŸ’§ðŸ¥¨ðŸŒŒðŸ‚ðŸ ðŸ¥¦ðŸ¥šðŸ¥ðŸŽŸðŸ¥¥ðŸ¥’ðŸ›µðŸ¥–ðŸ’ðŸ¯ðŸŽ¾ðŸŽ²ðŸºðŸšðŸ®âŒ›ï¸'
    }));
  }
});
...
function WelcomeGuide() {
  ...
  return Object(external_this_wp_element_["createElement"])(external_this_wp_components_["Guide"], {
    ...
    pages: [{
      ...
      }, Object(external_this_wp_i18n_["__"])('In the WordPress editor, each paragraph, image, or video is presented as a distinct â€œblockâ€ of content.')))
    }, {
      ...
      content: Object(external_this_wp_element_["createElement"])(external_this_wp_element_["Fragment"], null, Object(external_this_wp_element_["createElement"])("h1", {
        ...
        className: "edit-post-welcome-guide__text"
      }, Object(external_this_wp_element_["createInterpolateElement"])(Object(external_this_wp_i18n_["__"])('All of the blocks available to you live in the block library. Youâ€™ll find it wherever you see the <InserterIconImage /> icon.'), {
